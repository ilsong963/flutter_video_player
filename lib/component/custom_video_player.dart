...
class _CustomVideoPlayerState extends State<CustomVideoPlayer> {
              ...
              children: [
                ...
                if (showControls)
                  Align(
                    ...
                    child: CustomIconButton(onPressed: widget.onNewVideoPressed, iconData: Icons.photo_camera_back),
                  ),
                if (showControls)
                  Align(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          CustomIconButton(onPressed: onPlayPressed, iconData: Icons.play_arrow),
  ...
  void onReversePressed() {
    ...
    if (current.inSeconds > 3) {
      position = current - Duration(seconds: 3);
    }
